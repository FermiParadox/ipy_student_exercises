...
class Test__is_valid_answer(TestCase):
    ...
    def test_anynumber_valid(self):
        self.assertTrue(Exercise._is_valid_answer(answer=ANY_NUMBER, allowed_answer_types=[AnyNumber]))

    def test_nosolution_valid(self):
        self.assertTrue(Exercise._is_valid_answer(answer=NO_SOLUTION, allowed_answer_types=[NoSolution]))

    def test_nosolution_invalid(self):
        self.assertFalse(Exercise._is_valid_answer(answer=NO_SOLUTION, allowed_answer_types=[AnyNumber]))
